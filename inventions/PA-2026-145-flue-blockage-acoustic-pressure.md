...
dP = 3462 * h * (1/T_outdoor - 1/T_flue)

where dP is the draft pressure in Pa, h is the effective stack height in meters, temperatures are in Kelvin, and the constant 3462 derives from P_atm * M_air * g / R (101,325 Pa * 0.029 kg/mol * 9.81 m/s^2 / 8.314 J/(mol*K)). For an 8-meter flue with outdoor temperature of 0C (273 K) and flue gas temperature of 200C (473 K), the theoretical draft is approximately -42.9 Pa. In practice, vent connector friction, bends, and damper resistance reduce measured draft to 25-35% of theoretical, yielding typical operating values of -5 Pa (marginal) to -25 Pa (strong) in residential installations. The sensor measures draft at 1 Hz during combustion appliance operation and at 0.1 Hz during idle periods.
